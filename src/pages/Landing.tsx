      ...
      <Container>
        <section className="py-16 md:py-20">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="badge border-emerald-400/25 bg-emerald-500/10 text-emerald-200">
                <Sparkles size={14} /> A social lending network for students
              </div>
              <h1 className="mt-4 text-4xl md:text-5xl font-semibold tracking-tight">
                Send money like UPI — <span className="text-emerald-300">but built for lending</span>.
              </h1>
              ...
              <div className="mt-7 grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="card">
                  ...
                  <div className="mt-2 text-sm text-slate-300">Friends + friends-of-friends, not strangers.</div>
                </div>
                <div className="card">
                  <div className="badge"><Percent size={14} /> Clear terms</div>
                  <div className="mt-2 text-sm text-slate-300">Interest + duration shown upfront.</div>
                </div>
                <div className="card">
                  <div className="badge"><ShieldCheck size={14} /> Trust layers</div>
                  <div className="mt-2 text-sm text-slate-300">Profiles, mutuals, and history.</div>
                </div>
              </div>
            </div>
                ...
                <div className="mt-4 space-y-3">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="badge border-emerald-400/25 bg-emerald-500/10 text-emerald-200">Request</span>
                    </div>
                    <div className="mt-2 text-sm text-slate-300">Pay back in 14 days • 4% interest • Friends-of-friends</div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-center justify-between">
                      <div className="font-medium">“I can lend up to $200”</div>
                      <span className="badge border-cyan-400/25 bg-cyan-500/10 text-cyan-200">Offer</span>
                    </div>
                    <div className="mt-2 text-sm text-slate-300">30 days • 6% interest • Friends</div>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="mt-2 text-sm text-slate-300">7 days • 2% interest • Friends</div>
                  </div>
                </div>
          ...
          <section id="how" className="mt-16">
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-4">
              <div className="card">
                ...
                <div className="mt-2 text-sm text-slate-300">Create your profile and verify your student identity later.</div>
              </div>
              <div className="card">
                <div className="font-semibold">2) Build your network</div>
                <div className="mt-2 text-sm text-slate-300">Add friends, see mutuals, discover friends-of-friends.</div>
              </div>
              <div className="card">
                <div className="font-semibold">3) Lend with terms</div>
                <div className="mt-2 text-sm text-slate-300">Post requests/offers with amount, interest, and duration.</div>
              </div>
            </div>
          </section>
        </section>
